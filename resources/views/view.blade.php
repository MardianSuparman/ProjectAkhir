    ...
    @foreach ($jurusan as $data)
            <article class="postcard dark blue">
                {{-- <a class="postcard__img_link" href="#">
                    <img class="postcard__img" src="{{asset('/storage/jurusans/'. $data->image)}}" alt="Image Title" />
                </a> --}}
                <div class="postcard__text">
                    <h1 class="postcard__title blue">{{ $data->nama_jurusan }}</a></h1>
                    ...
                    <div class="postcard__preview-txt">{{ $data->isi_jurusan}}</div> --}}
